...
public class CompanyRegistration extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        } else if (!Pattern.compile("0[0-9]{9}").matcher(jTextField2.getText()).matches()) {
            JOptionPane.showMessageDialog(this, "Invalied Contact Number", "Warning", JOptionPane.WARNING_MESSAGE);
        }else{
            try {
                ResultSet rs = MySQL.search("SELECT * FROM company WHERE `name` = '"+jTextField1.getText()+"'");
                
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "Company Already Exsits", "Warning", JOptionPane.WARNING_MESSAGE);
                }else{
                    MySQL.iud("INSERT INTO `company`(`name`,`contact_number`) VALUES('"+jTextField1.getText()+"','"+jTextField2.getText()+"')");
                    loadCompanies();
                    jTextField1.setText("");
                    jTextField2.setText("");
