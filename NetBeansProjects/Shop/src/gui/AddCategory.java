...
public class AddCategory extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTextField1.getText().isBlank()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `category` WHERE `name` = '" + jTextField1.getText() + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This Category is already Exsits", "Warning", JOptionPane.WARNING_MESSAGE);
                } else {
                    MySQL.iud("INSERT INTO `category`(`name`) VALUES('" + jTextField1.getText() + "')");
                    JOptionPane.showMessageDialog(this, "New Category is Created", "Success", JOptionPane.INFORMATION_MESSAGE);
                    loadCategory();
                }
            } catch (Exception e) {
                e.printStackTrace();
