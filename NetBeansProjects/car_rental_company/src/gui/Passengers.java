...
public class Passengers extends javax.swing.JFrame {
    ...
    public Passengers(Car_Renting parent,boolean model) {
        this.cr = parent;
        initComponents();
        loadCity();
        loadTable();
    ...
    public void loadTable() {
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `passengers` INNER JOIN `city` ON `passengers`.`city_id` = `city`.`id` ORDER BY `fname` ASC");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nic.isBlank()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `passengers` WHERE `nic` = '" + nic + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This passenger is already excits", "Warning", JOptionPane.WARNING_MESSAGE);
                    resetFields();
                } else {
                    ...
                    MySQL.iud("iNSERT INTO `passengers` (`nic`,`fname`,`lname`,`mobile`,`email`,`address`,`city_id`) VALUES('" + nic + "','" + fname + "','" + lname + "','" + mobile + "','" + email + "','" + address + "','" + city_id + "')");
                    resetFields();
                    loadTable();
                    JOptionPane.showMessageDialog(this, "New Owner Added", "Success", JOptionPane.INFORMATION_MESSAGE);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `passengers` INNER JOIN `city` ON `passengers`.`city_id` = `city`.`id` WHERE `nic` = '" + search + "' ORDER BY `fname` ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            cr.jLabel3.setText(jTable1.getValueAt(selectedrow, 0).toString());
            cr.jLabel3.setText(jTable1.getValueAt(selectedrow, 0).toString());
            this.dispose();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (nic.isBlank()) {
            ...
            try {
                ...
                MySQL.iud("UPDATE `passengers` SET `fname` = '"+fname+"', `lname` = '"+lname+"', `mobile` = '"+mobile+"', `email` = '"+email+"', `address` = '"+address+"', `city_id` = '"+city_id+"' WHERE `nic` = '"+nic+"'");
                resetFields();
                loadTable();
                JOptionPane.showMessageDialog(this, "Passenger updated", "Success", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
