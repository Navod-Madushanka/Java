...
public class owner extends javax.swing.JFrame {
    ...
    public owner(Car_Registration parent,boolean model) {
        this.cr = parent;
        initComponents();
        loadCity();
        loadTable();
    ...
    public void loadTable() {
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `owner` INNER JOIN `city` ON `owner`.`city_id` = `city`.`id` ORDER BY `fname` ASC");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nic.isBlank()) {
            ...
            try {
                ResultSet rs = MySQL.search("SELECT * FROM `owner` WHERE `nic` = '" + nic + "'");
                if (rs.next()) {
                    JOptionPane.showMessageDialog(this, "This Owner is already excits", "Warning", JOptionPane.WARNING_MESSAGE);
                    resetFields();
                } else {
                    ...
                    MySQL.iud("iNSERT INTO `owner` (`nic`,`fname`,`lname`,`mobile`,`email`,`address`,`city_id`) VALUES('" + nic + "','" + fname + "','" + lname + "','" + mobile + "','" + email + "','" + address + "','" + city_id + "')");
                    resetFields();
                    loadTable();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ResultSet rs = MySQL.search("SELECT * FROM `owner` INNER JOIN `city` ON `owner`.`city_id` = `city`.`id` WHERE `nic` = '" + search + "' ORDER BY `fname` ASC");
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            while (rs.next()) {
                Vector v = new Vector();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            cr.jLabel14.setText(jTable1.getValueAt(selectedrow, 0).toString());
            this.dispose();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (nic.isBlank()) {
            ...
            try {
                ...
                MySQL.iud("UPDATE `owner` SET `fname` = '"+fname+"', `lname` = '"+lname+"', `mobile` = '"+mobile+"', `email` = '"+email+"', `address` = '"+address+"', `city_id` = '"+city_id+"' WHERE `nic` = '"+nic+"'");
                resetFields();
                loadTable();
                JOptionPane.showMessageDialog(this, "Owner updated", "Success", JOptionPane.INFORMATION_MESSAGE);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
